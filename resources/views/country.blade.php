        ...
        <div class="container">
            ...
            <div class="py-3 border-bottom border-success-subtle">
                <h2 class="text-dark fs-4 fw-bold mb-0 d-flex align-items-center">
                    ...
                    @else
                        <span class="me-2">No flag</span>
                    @endif
                    Escorts in {{ $country->name }}
                    <img src="https://flagcdn.com/24x18/{{ strtolower($country->iso2) }}.png"
                        alt="{{ $country->name }} Flag" class="img-fluid me-2" style="width: 24px; height: auto;" />
                ...
                @empty
                    <div class="col-12">
                        <div class="text-center py-5">
                            <h5 class="text-muted">No escorts found in this country</h5>
                            <p class="text-muted">Try checking other countries or adjust your filters.</p>
                        </div>
                    </div>
                @endforelse
            </div>
