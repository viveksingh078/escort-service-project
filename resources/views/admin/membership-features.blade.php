        ...
        jQuery(document).ready(function ($) {
            ...
            function loadFeatures() {
                $('#featureTable').DataTable({
                    ...
                    destroy: true,
                    ajax: {
                        url: '{{ route("admin.mfeatures.list") }}',
                        type: 'GET'
                    },
                    columns: [
            ...
            $('#featureForm').on('submit', function (e) {
                ...
                const url = id ? '{{ route("admin.mfeatures.update", ["id" => ":id"]) }}'.replace(':id', id) : '{{ route("admin.mfeatures.store") }}';
            ...
            $(document).on('click', '.editBtn', function () {
                ...
                $.ajax({
                    url: '{{ route("admin.mfeatures.edit", ["id" => ":id"]) }}'.replace(':id', id),
                    type: 'GET',
            ...
            $(document).on('click', '.delFeatureBtn', function () {
                ...
                if (confirm('Are you sure you want to delete this feature?')) {
                    $.ajax({
                        url: '{{ route("admin.mfeatures.delete", ["id" => ":id"]) }}'.replace(':id', id),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
