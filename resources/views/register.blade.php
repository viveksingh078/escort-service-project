...
<div class="container-fluid p-0 m-0 register-page">
  <div class="container py-5 register-page-inner">
    <div class="row">
      <div class="col-sm-12 col-lg-6 col-md-6 mx-auto">
        <div class="shadow-sm p-4 register-page-inner-div bg-white my-5">
          <div class="text-center">
            <h2 class="h1">Register</h2>
            <p class="text-muted mt-2">Choose what kind of account you would like to create</p>
          </div>
          <div class="row mt-4">
            <div class="col-sm-12 col-lg-6 col-md-6 mb-4">
              <div class="card border-0 regiter-card">
                <div class="card-body text-center bg-white">
                  ...
                  <a href="{{ route('escort.register') }}"><h5 class="mt-3 card-title">I'm an ESCORT</h5></a>
                </div>
              </div>
            </div>
            <div class="col-sm-12 col-lg-6 col-md-6 mb-4">
              <div class="card border-0 regiter-card">
                <div class="card-body text-center bg-white">
                  ...
                  <a href="{{ route('fan.register') }}"><h5 class="card-title mt-3">I'm a FAN</h5></a>
                </div>
              </div>
