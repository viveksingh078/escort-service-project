          ...
          <div class="col-sm-12 col-lg-6 offset-lg-3 col-md-6 offset-md-3">
            ...
            <div class="d-flex justify-content-center align-items-center">
              <div class="glass-card">
                ...
                <form action="{{ route('fan.authenticate') }}" method="post" >
                  @csrf
                ...
                <div class="text-center mt-4">
                  <p class="text-muted fw-bolder small">Don't have an account? <a href="{{ route('fan.register')}}" class="font-weight-bold">Sign up</a></p>
                </div>
              </div>
            </div>
