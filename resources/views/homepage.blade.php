        ...
        <div class="col-12">
          <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
              <a class="navbar-brand" href="{{ route('home') }}">Escort Site</a>
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                  @if(Auth::guard('fan')->check())
                    <li class="nav-item">
                      <span class="nav-link">Logged in as {{ Auth::guard('fan')->user()->name }}</span>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link btn btn-danger" href="{{ route('fan.logout') }}">Logout</a>
                    </li>
                  @else
                    <li class="nav-item">
