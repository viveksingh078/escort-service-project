          ...
          <div class="col-sm-12 col-lg-6 offset-lg-3 col-md-6 offset-md-3">
            ...
            <div class="d-flex justify-content-center align-items-center">
              <div class="glass-card">
                ...
                <form action="{{ route('escort.authenticate') }}" method="post" >
                  @csrf
                  <div class="form-group mb-3">
                    <label for="email" class="fw-bold mb-1 text-muted small">Email</label>
                    <input type="email" name="email" value="{{old('email')}}" class="form-control input-field @error('email') is-invalid @enderror" id="email" placeholder="Enter your email">
                     @error('email')
                ...
                <div class="text-center mt-4">
                  <p class="text-muted fw-bolder small">Don't have an account? <a href="{{ route('escort.register')}}" class="font-weight-bold">Sign up</a></p>
                </div>
              </div>
            </div>
