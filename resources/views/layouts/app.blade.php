    ...
    <header>
      <div id="header-top" class="container-xl py-3">
        <div class="px-1 py-1 bg-white row align-items-center">
          ...
          <div
            class="px-1 py-1 col-6 col-lg-1 justify-content-center align-items-center d-flex mt-2 mt-lg-0"
          >
            <a href="{{ route('login') }}" 
                ...
                <ul class="d-flex list-unstyled mb-0 gap-4">
                  ...
                  <li>
                    <a href="{{ route('register') }}" class="text-white"
                      ><span
                        ><i class="fa-solid fa-user-tie text-main me-2"></i
                      ></span>
                      signup</a
                    >
                  </li>
                  <li>
                    <a href="#" class="text-white"
                      ><span
                        ><i
                          class="fa-solid fa-right-from-bracket text-main me-2"
                        ></i></span
                      >login</a
                    >
                  </li>
