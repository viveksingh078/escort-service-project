...
<div class="container-fluid p-0 m-0 fan-register-page">
    <div class="container py-5">
        <div class="row">
            <div class="col-12 mx-auto">
                <div class="fan-register-inner shadow-sm p-5">
                    ...
                    <form action="{{ route('fan.processRegister') }}" method="POST">
                        @csrf
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="form-check mb-3">
                                ...
                                <label class="form-check-label" for="marketing">
                                    Send me cool marketing stuff that I might like
                                </label>
                            </div>
                        </div>
